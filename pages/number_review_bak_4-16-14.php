...
<script type="text/javascript">
	...
	$("body > div #html_review #body_review").bind('click',function(event){
		...
		if( (idVar.indexOf("box") != -1) || idVar == "big" )
		{
			...
			if(idVarNum == chooseNum || idVar == "big"){
				...
				setTimeout(function () { rightAnswer(); }, 900); //700, 800, 850, 
				// 700 works
				// 1000 works
				// 1200 doesnt
				// 1500 doesnt
				...
				setTimeout(function () { playChooseNum(randArray[iterationCount-1]); }, 4800);
				showReinforcer();
			}
			else
			{
	...
	function wrongAnswer() {
		...
		errorCount++;
		if (errorCount == 1) {
			setTimeout(function () { playChooseNum(randArray[iterationCount - 1]); }, 1400);
			setTimeout(function () { document.getElementById(boxvar).style.backgroundColor = '#FFFF00'; }, 2700);
	...
	function showReinforcer() {
		...
		setTimeout(function () { createGrid(); }, 4500);
